...
BETA_1_NAME = "beta-1.0"
BETA_1_DISPLAY_NAME = "Beta 1.0"

# Pairs are ordered as (scorey_pick, user_pick).
BETA_1_PASS_PAIRS: tuple[tuple[str, str], ...] = (
    ("paper", "scissors"),
    ("rock", "paper"),
    ("scissors", "rock"),
    ("paper", "paper"),
...
FAIL_REASON = "not a beta 1.0 route"
