...
class EvalGateTests(TestCase):
    ...
    def test_beta_1_pass_pairs_match_the_current_runtime_contract(self) -> None:
        ...
        self.assertEqual(set(RESEARCH_BETA_1_PASS_PAIRS), expected_pairs)
